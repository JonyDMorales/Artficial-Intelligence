;(load "/home/jonyd/Escritorio/Sexto Semestre/Artificial/Ejercicios/retriever.lisp")

#|
(defparameter *caballo* '(
    (<- (es-caballo ?y) (padre-de ?x ?y) (es-caballo ?x))
    (<- (es-caballo Furia))
    (<- (padre-de Furia Rosinante))))

(with-kb *caballo* (ask '(es-caballo ?x)))
|#
